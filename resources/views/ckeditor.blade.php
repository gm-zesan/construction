                ...
                <div class="card table-card">
                    ...
                    <div class="card-body custom-form p-4">
                        <div class="alert alert-info d-flex align-items-center mb-4" role="alert"
                            style="border-left: 4px solid #f95716; background: rgba(249, 87, 22, 0.08); color: #111a3a;">
                            <i class="ri-information-line fs-4 me-2" style="color: #f95716;"></i>
                            <div>
                                <strong>WYSIWYG Rich Text Engine:</strong> Full image upload, formatting, table tools, and
                                inline media embeds enabled with Laravel asset management.
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-12">
                                <label for="editor_demo" class="form-label custom-label fw-bold mb-2">Editor Content
                                    Canvas</label>
