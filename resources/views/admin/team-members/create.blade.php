                                    ...
                                    <div id="photo_dropzone" class="dropzone-box">
                                        ...
                                        <div id="photo_preview_box" class="d-none">
                                            <div class="position-relative rounded overflow-hidden mx-auto mb-2 border shadow-sm" style="width: 140px; height: 165px; background: #f8fafc;">
                                                <img id="photo_preview_img" src="" alt="Portrait preview" style="width: 100%; height: 100%; object-fit: cover;">
                                                <button type="button" class="preview-remove-btn" id="btn_remove_photo" title="Remove selected photo">
