                        ...
                        <div class="card-body custom-form p-4">
                            <div class="row g-3">
                                ...
                                <div class="col-md-7 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('title') is-invalid @enderror" name="title" id="title" value="{{ old('title') }}" placeholder="e.g. Advancements in Mass Timber & Seismic Damping" required>
                                    @error('title')
                                ...
                                <div class="col-md-5 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('slug') is-invalid @enderror" name="slug" id="slug" value="{{ old('slug') }}" placeholder="Auto-generated if empty">
                                    @error('slug')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-4 col-12">
                                    ...
                                    <input type="text" class="form-control custom-input @error('author_name') is-invalid @enderror" name="author_name" id="author_name" value="{{ old('author_name', Auth::user()?->name ?? 'Editorial Team') }}" placeholder="e.g. Lead Engineer, Project Ops">
                                    @error('author_name')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-3 col-12">
                                    ...
                                    <input type="number" class="form-control custom-input @error('read_time') is-invalid @enderror" name="read_time" id="read_time" value="{{ old('read_time', 3) }}" min="1" max="120">
                                    @error('read_time')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input @error('summary') is-invalid @enderror" name="summary" id="summary" rows="3" placeholder="Brief 1-2 sentence overview shown on homepage cards and search snippets...">{{ old('summary') }}</textarea>
                                    @error('summary')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea class="form-control custom-input @error('content') is-invalid @enderror" name="content" id="editor" rows="12">{{ old('content') }}</textarea>
                                    @error('content')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="card-body custom-form p-4">
                            <div class="row g-3">
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control custom-input" name="meta_title" id="meta_title" value="{{ old('meta_title') }}" placeholder="Custom page title for search engines">
                                </div>
                                <div class="col-12">
                                    <label for="meta_description" class="form-label custom-label">Meta Description</label>
                                    <textarea class="form-control custom-input" name="meta_description" id="meta_description" rows="2" placeholder="Search result snippet (recommended under 160 characters)">{{ old('meta_description') }}</textarea>
                                </div>
                                <div class="col-12">
                                    <label for="meta_keywords" class="form-label custom-label">Meta Keywords</label>
                                    <input type="text" class="form-control custom-input" name="meta_keywords" id="meta_keywords" value="{{ old('meta_keywords') }}" placeholder="e.g. construction technology, mass timber, seismic safety">
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="card-body custom-form p-4">
                                    <div class="d-flex flex-column gap-3 mb-4">
                                        ...
                                        <div>
                                            ...
                                            <input type="datetime-local" class="form-control custom-input" name="published_at" id="published_at" value="{{ old('published_at', now()->format('Y-m-d\TH:i')) }}">
                                            <div class="text-muted" style="font-size: 11px;">Default is current timestamp</div>
                                        </div>
                                    ...
                                    <div id="image_dropzone" class="dropzone-box">
                                        ...
                                        <div id="image_preview_box" class="d-none">
                                            <div class="position-relative rounded overflow-hidden mb-2" style="height: 160px; background: #000;">
                                                <img id="image_preview_img" src="" alt="Cover preview" style="width: 100%; height: 100%; object-fit: cover;">
