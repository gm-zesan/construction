                    ...
                    <div class="card table-card mb-4">
                            ...
                            <div class="title-with-breadcrumb">
                                ...
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb mb-0">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('milestones.index') }}">Milestones</a>
                                        </li>
                        ...
                        <div class="card-body custom-form p-4">
                            <div class="row g-3">
                                {{-- Project Selection --}}
                                <div class="col-md-12">
                                    <label for="project_id" class="form-label custom-label">Associated Construction Project
                                ...
                                {{-- Milestone Title --}}
                                <div class="col-md-12">
                                    <label for="title" class="form-label custom-label">Milestone Title <span
                                            class="text-danger">*</span></label>
                                    <input type="text"
                                        class="form-control custom-input @error('title') is-invalid @enderror" name="title"
                                        id="title" value="{{ old('title') }}"
                                        placeholder="e.g. Structural Steel Superstructure Complete" required>
                                    @error('title')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label for="target_date" class="form-label custom-label">Target Completion Date <span
                                            class="text-danger">*</span></label>
                                    <input type="date"
                                        class="form-control custom-input @error('target_date') is-invalid @enderror"
                                        name="target_date" id="target_date" value="{{ old('target_date', date('Y-m-d')) }}"
                                        required>
                                    @error('target_date')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    <label for="completion_date" class="form-label custom-label">Actual Completion Date
                                        (Optional)</label>
                                    <input type="date"
                                ...
                                <div class="col-md-12">
                                    <label for="progress_percentage"
                                        class="form-label custom-label d-flex justify-content-between">
                                        <span>Milestone Execution Progress</span>
                                        <span class="fw-bold text-primary"
                                            id="progressValBadge">{{ old('progress_percentage', 0) }}%</span>
                                    </label>
                                    <input type="range" class="form-range" name="progress_percentage"
                                        id="progress_percentage" min="0" max="100" step="5"
                                        value="{{ old('progress_percentage', 0) }}"
                                        oninput="$('#progressValBadge').text(this.value + '%');">
                                </div>

                                {{-- Description --}}
                                <div class="col-12">
                                    <label for="description" class="form-label custom-label">Phase Description &amp; Scope
                                        of Inspection</label>
                                    <textarea class="form-control custom-input @error('description') is-invalid @enderror"
                                        name="description" id="description" rows="4"
                                        placeholder="Detailed summary of work completed for this milestone...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="text-danger mt-1" style="font-size: 12px;">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="card table-card">
                                ...
                                <div class="card-body custom-form p-3">
                                    <div class="d-flex flex-column gap-3 mb-3">
                                        <div>
                                            <label for="status" class="form-label custom-label mb-1">Current Status <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div>
                                            <label for="sort_order" class="form-label custom-label mb-1">Sequence
                                                Order</label>
                                ...
                                <div class="card-body custom-form p-3">
                                    ...
                                    <div id="image_dropzone" class="dropzone-box">
                                        <div id="image_empty">
                                            ...
                                            <p class="fw-bold text-dark mb-1" style="font-size: 13px;">Drop site photo here
                                            </p>
                                            <span class="text-muted d-block mb-3" style="font-size: 11.5px;">PNG, JPG up to
                                                10MB</span>
                                        ...
                                        <div id="image_preview_box" class="d-none">
                                            <div class="position-relative rounded overflow-hidden mb-2"
                                                ...
                                                <img id="image_preview_img" src="" alt="Verification preview"
